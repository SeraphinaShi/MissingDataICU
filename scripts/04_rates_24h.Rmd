...
tmp1 <- df_24h %>% 
  dplyr::select(ICUSTAY_ID, AGE, GENDER_F, INSURANCE_Y, RELIGION_Chrt, 
                ...
                ETHNICITY_B, ETHNICITY_A, ETHNICITY_H, Y_t_plus_1) %>%
  unique() 
...
tmp1$Y_t_plus_1[tmp1$Y_t_plus_1 == 0] = "Survived"
tmp1$Y_t_plus_1[tmp1$Y_t_plus_1 == 1] = "ICU Mortality"

table <- tmp1 %>%
  select(Age, Gender, Ethnicity, Marital, Language, Religion, Insurance, Y_t_plus_1) %>%
  tbl_summary(
    by = Y_t_plus_1,  # Add this line to stratify by 'outcome'
...
```{r}
load(here('data', 'rdata', '07_24h_age.RData'))
...
```{r}
load('data', 'rdata', here('07_24h_eth.RData'))
plotFolder <- here("results","images", "04_24h")
```
...
## 0. TMLE estimations plots
```{r}
load(here('data', 'rdata', '07_24h_gender.RData'))
