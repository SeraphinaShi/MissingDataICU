...
results_df_tmp <- results_df_tmp |>
  dplyr::mutate(var_set = case_when(
    var == "W, VS, LT" ~ "Value variables",
    var == "n_W, n_VS, h_m_VS, n_LT" ~ "Counting variables",
    var == "W, VS, LT, n_W, n_VS, h_m_VS, n_LT" ~ "Value and counting variables",
  ))

results_df_tmp$var_set <- factor(results_df_tmp$var_set, levels = c("Value and counting variables",  "Counting variables", "Value variables"))
